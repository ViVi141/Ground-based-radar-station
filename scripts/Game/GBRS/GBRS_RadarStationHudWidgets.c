...
class GBRS_RadarStationHudWidgets
{
    ...
    Widget m_wListTable;
    TextWidget m_wListHNr;
    TextWidget m_wListHAz;
    TextWidget m_wListHRng;
    TextWidget m_wListHAlt;
    TextWidget m_wListHSpd;
    TextWidget m_wListHType;
    TextWidget m_wListHSnr;
    ...
    bool Init(Widget root)
    {
        ...
        m_wListHNr = TextWidget.Cast(root.FindAnyWidget("ListH_Nr"));
        m_wListHAz = TextWidget.Cast(root.FindAnyWidget("ListH_Az"));
        m_wListHRng = TextWidget.Cast(root.FindAnyWidget("ListH_Rng"));
        m_wListHAlt = TextWidget.Cast(root.FindAnyWidget("ListH_Alt"));
        m_wListHSpd = TextWidget.Cast(root.FindAnyWidget("ListH_Spd"));
        m_wListHType = TextWidget.Cast(root.FindAnyWidget("ListH_Type"));
        m_wListHSnr = TextWidget.Cast(root.FindAnyWidget("ListH_Snr"));
